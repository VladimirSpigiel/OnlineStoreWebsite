 ...
 * Choice
 *
 * @ORM\Table(name="Choice", indexes={@ORM\Index(name="FKChoice649845", columns={"product"}), @ORM\Index(name="FKChoice649849", columns={"product_archive"})})
 * @ORM\Entity
 *
 *
 */
class Choice
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="product", referencedColumnName="id", onDelete=NULL)
     * })
     */
    protected $product;
     ...
     * @var ProductArchive
     *
     * @ORM\ManyToOne(targetEntity="ProductArchive" )
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="product_archive", referencedColumnName="id", onDelete=NULL)
     * })
     */
    protected $productArchive;
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="promotion", referencedColumnName="id", onDelete=NULL)
     * })
     */
    protected $promotion;
     ...
     * Set productArchive
     *
     * @param \Sru\CoreBundle\Entity\ProductArchive $productArchive
     * @return Choice
     */
    public function setProductArchive(\Sru\CoreBundle\Entity\ProductArchive $productArchive = null)
    {
     ...
     * Get productArchive
     *
     * @return \Sru\CoreBundle\Entity\ProductArchive 
     */
    public function getProductArchive()
    {
        return $this->productArchive;
    }
}
